...
export default function WalletModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="w-full max-w-[95vw] sm:max-w-[90vw] md:max-w-[80vw] lg:max-w-[70vw] xl:max-w-[60vw] h-[90vh] max-h-[800px] p-0 bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-xl shadow-2xl overflow-hidden overflow-x-auto">
        {' '}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p
                  ...
                  onClick={() =>
                    navigator.clipboard.writeText(walletData.email || '')
                  }
                >
                  {walletData.email}
                </p>
