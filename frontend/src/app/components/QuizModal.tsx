              ...
              <ScrollArea className="h-[60vh] pr-4">
										...
										{!showResults ? (
											...
											<div className="space-y-4 max-h-[50vh] overflow-y-auto pr-2">
												...
												{quizzes.map((quiz, index) => (
													<div key={quiz.id} className="p-4 bg-gray-800 rounded-xl shadow-inner">
							...
							{showResults && (
								<div className="mt-4">
									...
									<Button onClick={() => setIsOpen(false)} className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold py-2 rounded-full text-base shadow-lg transform transition duration-500 hover:scale-105">
										閉じる
									</Button>
								</div>
							)}
