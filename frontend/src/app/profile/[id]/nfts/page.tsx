              ...
              {nfts.map((nft, index) => (
                ...
                >
                  ...
                  <CardContent className="p-4 relative">
                    <h3 className="text-xl font-semibold mb-2 text-blue-400 group-hover:text-blue-300 transition-colors duration-300 whitespace-nowrap overflow-hidden text-ellipsis">
                      {nft.name}
                    </h3>
                    <p className="text-gray-400 mb-4 line-clamp-2 overflow-hidden text-ellipsis min-h-[3rem]">
                      {nft.description}
                    </p>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://testnets.opensea.io/assets/sepolia/0xbe7EeFb23E7B970fcC05F061ba22A0E8dAd94518/${nft.tokenId}`,
                          '_blank'
                        )
                      }
                    >
